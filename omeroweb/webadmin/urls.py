...
urlpatterns = [
    ...
    path(
        'login/', WebclientLoginView.as_view(),
        name="walogin"),
    path('logout/', views.logout, name="walogout"),
    path(
        'forgottenpassword/', views.forgotten_password,
    ...
    path(
        'change_password/<int:eid>/', views.manage_password,
    ...
    path(
        'drivespace_json/groups/', views.drivespace_json,
        {'query': 'groups'}, name="waloaddrivespace_groups"),
    path(
        'drivespace_json/users/', views.drivespace_json,
        {'query': 'users'}, name="waloaddrivespace_users"),
    path(
        'drivespace_json/group/<int:groupId>/',
        views.drivespace_json, name="waloaddrivespace_group"),
    path(
        'drivespace_json/user/<int:userId>/',
