...
urlpatterns = [
    ...
    re_path(r'^login/$', WebclientLoginView.as_view(),
        name="walogin"),
    re_path(r'^logout/$', views.logout, name="walogout"),
    re_path(r'^forgottenpassword/$', views.forgotten_password,
    ...
    re_path(r'^change_password/(?P<eid>[0-9]+)/$', views.manage_password,
    ...
    re_path(r'^drivespace_json/groups/$', views.drivespace_json,
        {'query': 'groups'}, name="waloaddrivespace_groups"),
    re_path(r'^drivespace_json/users/$', views.drivespace_json,
        {'query': 'users'}, name="waloaddrivespace_users"),
    re_path(r'^drivespace_json/group/(?P<groupId>[0-9]+)/$',
        views.drivespace_json, name="waloaddrivespace_group"),
    re_path(r'^drivespace_json/user/(?P<userId>[0-9]+)/$',
