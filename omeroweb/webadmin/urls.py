...
urlpatterns = [
    ...
    path(r'login/', WebclientLoginView.as_view(),
        name="walogin"),
    path(r'logout/', views.logout, name="walogout"),
    path(r'forgottenpassword/', views.forgotten_password,
    ...
    path(r'change_password/<int:eid>/', views.manage_password,
    ...
    path(r'drivespace_json/groups/', views.drivespace_json,
        {'query': 'groups'}, name="waloaddrivespace_groups"),
    path(r'drivespace_json/users/', views.drivespace_json,
        {'query': 'users'}, name="waloaddrivespace_users"),
    path(r'drivespace_json/group/<int:groupId>/',
        views.drivespace_json, name="waloaddrivespace_group"),
    path(r'drivespace_json/user/<int:userId>/',
