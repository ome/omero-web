...
var fillTable = function (chart_data) {
  ...
  for (i = 0; i < chart_data.length; i++) {
    ...
    rowId =
      typeof rowData.userId != "undefined" ? rowData.userId : rowData.groupId;
    tableRows.push(
      '<tr><td class="link">' + rowData.label + "(id:" + rowId + ")</td>"
    );
    tableRows.push(
      '<td class="link">' + rowData.data.filesizeformat() + "</td></tr>"
    );
  }
