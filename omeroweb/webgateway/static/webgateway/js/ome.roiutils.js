...
$.fn.get_shape_config = function (
  ...
  var stroke_alpha =
    typeof stroke_alpha !== "undefined" ? stroke_alpha : 0.765625;
  var stroke_color =
    typeof stroke_color !== "undefined" ? stroke_color : "#c4c4c4";
...
$.fn.get_text_config = function (
  ...
  var fsize =
    typeof font_size !== "undefined" ? font_size : $.fn.get_font_size();
  return {
    fontFamily: ffamily,
    fontStyle: fstyle,
    fontSize: fsize,
...
$.fn.get_ome_rectangle = function (
  ...
  $.extend(
    rect_conf,
    $.fn.get_generic_shape(transform, z_plane, t_plane, "Rectangle")
  );
...
$.fn.get_ome_point = function (
  ...
  $.extend(
    point_conf,
    $.fn.get_generic_shape(transform, z_plane, t_plane, "Point")
  );
...
$.fn.get_ome_line = function (
  ...
  $.extend(
    line_conf,
    $.fn.get_generic_shape(transform, z_plane, t_plane, "Line")
  );
...
$.fn.get_ome_label = function (
  ...
  var text_conf = $.fn.get_text_config(
    text_value,
    font_family,
    font_size,
    font_style
  ...
  $.extend(
    label_conf,
    $.fn.get_generic_shape(transform, z_plane, t_plane, "Label")
  );
...
$.fn.get_ome_polygon = function (
  ...
  $.extend(
    polygon_conf,
    $.fn.get_generic_shape(transform, z_plane, t_plane, "Polygon")
  );
