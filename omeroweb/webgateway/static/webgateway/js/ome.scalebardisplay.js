...
$.fn.scalebar_display = function (options) {
  return this.each(function () {
    ...
    var scalebar_class = options.scalebar_class
      ? options.scalebar_class
    ...
    if (!tiles) {
      ...
      var scalebar_name = options.scalebar_name
        ? options.scalebar_name
        : viewerId + "-scalebar";
      var $scalebar = $(
        '<div id="' + scalebar_name + '" class="' + scalebar_class + '">'
      ).appendTo($dragdiv);
    } else {
      var scalebar_name = options.scalebar_name
        ? options.scalebar_name
        : viewerId + "-tiles-scalebar";
