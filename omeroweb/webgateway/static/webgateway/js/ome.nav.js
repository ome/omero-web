...
OME.nav.hide_left_panel = function () {
  ...
  $("#swapTree")
    .children("img")
    .removeClass("expanded-left")
    .addClass("collapsed-left");
};
...
OME.nav.show_left_panel = function () {
  ...
  $("#swapTree")
    .children("img")
    .removeClass("collapsed-left")
    .addClass("expanded-left");
};
  ...
  $("#dragLeft")
    ...
    .bind("dragstart", function (event, ui) {
      ...
      $("#swapTree")
        .children("img")
        .removeClass("collapsed-left")
        .addClass("expanded-left"); // show 'expanded'
    })
  ...
  $("#dragRight")
    ...
    .bind("dragstart", function (event, ui) {
      ...
      $("#swapMeta")
        .children("img")
        .removeClass("expanded-right")
        .addClass("collapsed-right"); // show 'expanded'
    })
    .bind("drag", function (event, ui) {
      var moved = event.pageX - $(this).data("drag_start_x");
