...
table_query = path(
    r"table/<int:fileid>/query/", views.table_query, name="webgateway_table_query"
)
"""
...
render_shape_mask = path(r"render_shape_mask/<int:shapeId>/", views.render_shape_mask)
"""
...
projectDetail_json = path(
    r"proj/<int:pid>/detail/",
...
listDatasets_json = path(
    r"proj/<int:pid>/children/",
...
datasetDetail_json = path(
    r"dataset/<int:did>/detail/",
...
wellData_json = path(
    r"wellData/<int:wid>/", views.wellData_json, name="webgateway_wellData_json"
)
"""
...
full_viewer = path(
    r"img_detail/<int:iid>/", views.full_viewer, name="webgateway_full_viewer"
)
"""
...
save_image_rdef_json = path(
    r"saveImgRDef/<int:iid>/",
...
listLuts_json = path(r"luts/", views.listLuts_json, name="webgateway_listLuts_json")
"""
...
list_compatible_imgs_json = path(
    r"compatImgRDef/<int:iid>/",
...
copy_image_rdef_json = path(
    r"copyImgRDef/", views.copy_image_rdef_json, name="webgateway_copy_image_rdef_json"
)
"""
...
reset_rdef_json = path(r"resetRDef/", views.reset_rdef_json, name="reset_rdef_json")
"""
...
webgateway_su = path(r"su/<slug:user>/", views.su, name="webgateway_su")
"""
...
original_file_paths = path(
    r"original_file_paths/<int:iid>/",
...
get_image_rdefs_json = path(
    r"get_image_rdefs_json/<int:img_id>/",
