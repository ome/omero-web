...
urlpatterns = [
    ...
    path(r'edit_channel_names/<int:imageId>/',
    ...
    path(r'download_placeholder/', views.download_placeholder,
    ...
    path(r'marshal_tagging_form_data/', views.marshal_tagging_form_data,
    ...
    path(r'download_orig_metadata/<int:imageId>/',
    ...
    path(r'script_ui/<int:scriptId>/',
        views.script_ui,
        name='script_ui'),  # shows a form for running a script
    path(r'script_run/<int:scriptId>/',
        views.script_run,
    ...
    path(r'api/groups/', views.api_group_list,
        name='api_groups'),
    ...
    path(r'api/share_images/<int:share_id>/', views.api_image_list,
    ...
    path(r'api/plate_acquisitions/', views.api_plate_acquisition_list,
    ...
    path(r'api/paths_to_object/', views.api_paths_to_object,
        name='api_paths_to_object'),

    # Get parents of 1 or more objects. ?image=1,2&dataset=3
    path(r'api/parent_links/', views.api_parent_links,
        name='api_parent_links'),

    path(r'api/tags/', views.api_tags_and_tagged_list,
        name='api_tags_and_tagged'),

    path(r'api/annotations/', views.api_annotations,
