...
function Slider(oElement, oInput, sOrientation) {
  ...
  this.doupdate = function () {
    if (typeof oThis.doupdate == "function") oThis.doupdate();
  };
  ...
  if (Slider.isSupported && oElement) {
    ...
    this.element.onkeyup = Slider.eventHandlers.onkeyup;
...
Slider.eventHandlers = {
    ...
    if (Slider._sliderDragData) {
      ...
      if (s._orientation == "horizontal") {
        ...
        pos =
          ...
          s.handle.offsetHeight -
          (e.screenY - Slider._sliderDragData.dy);
        reset = Math.abs(e.screenX - Slider._sliderDragData.screenX) > 100;
      }
      s.setValue(
        reset
          ? Slider._sliderDragData.startValue
    ...
    if (s) {
      ...
      if (doc.removeEventListener) {
        doc.removeEventListener(
          "mousemove",
          Slider.eventHandlers.onmousemove,
          true
        );
        doc.removeEventListener(
          "mouseup",
          Slider.eventHandlers.onmouseup,
          true
        );
  ...
  onkeydown: function (e) {
    ...
    switch (kc) {
      ...
      case 35: // end
        s.setValue(
          s.getOrientation() == "horizontal" ? s.getMaximum() : s.getMinimum()
        );
        break;
      case 36: // home
        s.setValue(
          s.getOrientation() == "horizontal" ? s.getMinimum() : s.getMaximum()
        );
        break;
      case 38: // up
      case 39: // right
...
Slider.prototype.recalculate = function () {
  ...
  if (this._orientation == "horizontal") {
    this.handle.style.left =
      ((w - hw) * (this.getValue() - this.getMinimum())) /
    ...
    this.handle.style.top =
      h -
      hh -
      ((h - hh) * (this.getValue() - this.getMinimum())) /
        (this.getMaximum() - this.getMinimum()) +
      "px";
