 ...
 * Build: http://www.modernizr.com/download/#-borderradius-boxshadow-hsla-opacity-rgba-textshadow-generatedcontent-cssgradients-shiv-cssclasses-teststyles-testprop-testallprops-prefixes-domprefixes-load
 */
(window.Modernizr = (function (a, b, c) {
  ...
  var H = (function (a, c) {
    ...
    x(
      ...
      function (a, c) {
        ...
        e.generatedcontent =
          (i.generatedcontent && i.generatedcontent.offsetHeight) >= 1;
      },
      f,
      c
    );
  ...
  (r.rgba = function () {
    return (
      A("background-color:rgba(150,255,150,.5)"), D(j.backgroundColor, "rgba")
    );
  }),
    (r.hsla = function () {
      return (
        A("background-color:hsla(120,40%,100%,.5)"),
        D(j.backgroundColor, "rgba") || D(j.backgroundColor, "hsla")
      );
    }),
